...
type NotesServiceClient interface {
	...
	GetNote(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*NoteResponse, error)
	UpdateNote(ctx context.Context, in *UpdateNoteRequest, opts ...grpc.CallOption) (*NoteResponse, error)
	DeleteNote(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*SuccessResponse, error)
	ListNotes(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*NotesListResponse, error)
}
...
func (c *notesServiceClient) GetNote(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*NoteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NoteResponse)
...
func (c *notesServiceClient) DeleteNote(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*SuccessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *notesServiceClient) ListNotes(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*NotesListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type NotesServiceServer interface {
	...
	GetNote(context.Context, *GetRequest) (*NoteResponse, error)
	UpdateNote(context.Context, *UpdateNoteRequest) (*NoteResponse, error)
	DeleteNote(context.Context, *GetRequest) (*SuccessResponse, error)
	ListNotes(context.Context, *Empty) (*NotesListResponse, error)
...
func (UnimplementedNotesServiceServer) GetNote(context.Context, *GetRequest) (*NoteResponse, error) {
...
func (UnimplementedNotesServiceServer) DeleteNote(context.Context, *GetRequest) (*SuccessResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteNote not implemented")
}
func (UnimplementedNotesServiceServer) ListNotes(context.Context, *Empty) (*NotesListResponse, error) {
...
func _NotesService_GetNote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotesServiceServer).GetNote(ctx, req.(*GetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _NotesService_DeleteNote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotesServiceServer).DeleteNote(ctx, req.(*GetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _NotesService_ListNotes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotesServiceServer).ListNotes(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
